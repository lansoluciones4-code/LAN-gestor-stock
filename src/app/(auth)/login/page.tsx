    ...
    <div className='w-full max-w-md bg-white dark:bg-zinc-900 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-8'>
      <div className='flex flex-col items-center mb-8'>
        ...
        <p className='text-zinc-500 dark:text-zinc-400 text-sm mt-1 text-center'>
          Inicia sesión para acceder a tu sistema de gestión.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='space-y-5' noValidate>
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-colors dark:bg-zinc-950 dark:border-zinc-800 dark:text-zinc-100 ${
              errors.username
