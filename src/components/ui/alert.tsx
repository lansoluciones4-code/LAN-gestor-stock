...
export function ErrorAlert({ error, className = '' }: ErrorAlertProps) {
  ...
  return (
    <div 
      className={`p-4 bg-red-50 text-red-600 text-sm rounded-lg border border-red-200 mb-6 dark:bg-red-900/10 dark:text-red-400 dark:border-red-900/30 ${className}`}
    >
      {error}
    </div>
  );
