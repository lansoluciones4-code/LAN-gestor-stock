...
function stockLabel(stock: number) {
  if (stock > 5) return { text: `${stock} Unidades`, cls: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' };
  if (stock > 0) return { text: `${stock} Unidades`, cls: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400' };
