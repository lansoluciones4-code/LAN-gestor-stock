...
import { ShoppingCart, ArrowLeft, Trash2, MinusCircle, PlusCircle, X, Search, Percent, Printer, Wrench } from 'lucide-react';
...
/** Botón "Desc" blanco + ícono % negro, con editor inline — compartido por las 3 líneas de carrito. */
function DiscountControl({ discountPercentage, isEditing, onToggle, value, onValueChange, onApply, onClear }: { discountPercentage: number; isEditing: boolean; onToggle: () => void; value: string; onValueChange: (v: string) => void; onApply: () => void; onClear: () => void }) {
  return (
